...
#endif
#define BinPath32 "..\AmznLinkShortener\bin\x86\Release\netcoreapp3.1\"
#define BinPath64 "..\AmznLinkShortener\bin\x64\Release\netcoreapp3.1\"
...
LicenseFile=..\AmznLinkShortener\bin\x64\Release\netcoreapp3.1\License.txt
OutputDir=.\release
OutputBaseFilename=setup
Compression=lzma
SolidCompression=yes
SetupIconFile=C:\Users\mbusc\source\repos\AmznLinkShortener\AmznLinkShortener\amazon_alt.ico
...
Source: "{#BinPath32}*.*"; DestDir: "{app}"; Flags: ignoreversion 32bit
Source: "{#BinPath32}\de\*.dll"; DestDir: "{app}\de"; Flags: ignoreversion 32bit

Source: "{#BinPath64}*.*"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
Source: "{#BinPath64}\de\*.dll"; DestDir: "{app}\de"; Flags: ignoreversion 64bit; Check: IsWin64
